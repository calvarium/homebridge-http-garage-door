...
| `autoClose`          | Automatically close the garage door if it has been open for too long                                                                                                        | `false`             |
| `autoCloseDelay`     | Time (in seconds) after which the garage door will be automatically closed (if `autoClose` is enabled)                                                                      | `3600`              |
